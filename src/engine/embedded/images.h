...
#define SHIT_SKYBOX_XPOS std::string("SHIT_SKYBOX_XPOS_png")
extern unsigned char SHIT_SKYBOX_XPOS_png[];
extern unsigned int SHIT_SKYBOX_XPOS_png_len;

#define SHIT_SKYBOX_YNEG std::string("SHIT_SKYBOX_YNEG_png")
extern unsigned char SHIT_SKYBOX_YNEG_png[];
extern unsigned int SHIT_SKYBOX_YNEG_png_len;

#define SHIT_SKYBOX_YPOS std::string("SHIT_SKYBOX_YPOS_png")
extern unsigned char SHIT_SKYBOX_YPOS_png[];
extern unsigned int SHIT_SKYBOX_YPOS_png_len;

#define SHIT_SKYBOX_ZNEG std::string("SHIT_SKYBOX_ZNEG_png")
extern unsigned char SHIT_SKYBOX_ZNEG_png[];
extern unsigned int SHIT_SKYBOX_ZNEG_png_len;

#define SHIT_SKYBOX_ZPOS std::string("SHIT_SKYBOX_ZPOS_png")
extern unsigned char SHIT_SKYBOX_ZPOS_png[];
extern unsigned int SHIT_SKYBOX_ZPOS_png_len;
