...
template<typename T> Actor*  createNewActor  (Theatre* parent_theatre, const int new_uid, const graphx::gSettings& new_settings) { return new T(parent_theatre, new_uid, new_settings); }
template<typename T> Device* createNewDevice (Theatre* parent_theatre, const int new_uid, const graphx::gSettings& new_settings) { return new T(parent_theatre, new_uid, new_settings); }

inline const std::map<std::string, Actor*(*)(Theatre*, const int, const graphx::gSettings&)>
valid_actors =
{
...
inline const std::map<std::string, Device*(*)(Theatre*, const int, const graphx::gSettings&)>
valid_devices =
{
