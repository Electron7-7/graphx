...
template<> std::vector<float> gmath::glmVectorToFloats(const glm::vec2& vector)
{ return std::vector<float>{vector.x, vector.y}; }

template<> std::vector<float> gmath::glmVectorToFloats(const glm::vec3& vector)
{ return std::vector<float>{vector.x, vector.y, vector.z}; }

template<> std::vector<float> gmath::glmVectorToFloats(const glm::vec4& vector)
{ return std::vector<float>{vector[0], vector[1], vector[2], vector[3]}; }